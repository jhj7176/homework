...
/* 			<ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
		...
		$('#putChapters').on('click', function() {
			$.post('${pageContext.request.contextPath }/put.bit', {
				'chapters' : chapters,
				'book_id' : bid,
				'title' : title,
				'writer' : writer,
				...
				//DB에 목차정보랑 책ID를 전달함
				location.href = '${pageContext.request.contextPath }/mybooks.bit?book_id=' + bid;
...
<div class="container-fluid">
	...
	<br/>
	<div class="row">
		<div id="book_detail" class="col-lg-6 col-md-12"></div>
	</div>
	<br/>
	<div class="row">
		<div id="chapter_list" class="col-lg-6 col-md-12"></div>
	</div>
	<br />
	<div class="row">
		<div class="col-lg-6 col-md-12">
